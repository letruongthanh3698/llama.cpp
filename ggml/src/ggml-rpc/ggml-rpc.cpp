...
enum rpc_cmd {
    ...
    //     The base is 32, NOT the next free stock id: see the headroom note on ggml_rpc_p2p_cmd in
    //     ggml-rpc.h. Upstream added MEMSET_TENSOR at 17 (2026-08-02) and collided with the old base. ---
    RPC_CMD_P2P_BASE = 32,
